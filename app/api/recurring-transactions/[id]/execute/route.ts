...
export async function POST(
  ...
  try {
    ...
    // If it's a transfer, create the corresponding transaction for the destination account
    if (recurringTx.type === 'transfer' && recurringTx.toAccountId) {
      ...
      const transferInResult = await transactionsCollection.insertOne(transferInTransaction as Transaction)
    }
